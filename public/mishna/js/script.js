...
$(document).ready(function () {
    ...
    // Tab Event Listeners
    $("#tab-mishna").click(function () { console.log('Clicked mishna'); switchTab('mishna'); });
    $("#tab-bartenura").click(function () { console.log('Clicked bartenura'); switchTab('bartenura'); });
...
function switchTab(tabName) {
    ...
    try {
        ...
        var columns = ['mishna', 'bartenura', 'rambam'];
        ...
        // Also update titles visibility if they share the same class structure
        // (The HTML I wrote uses the same classes for titles and content)
    } catch (e) {
